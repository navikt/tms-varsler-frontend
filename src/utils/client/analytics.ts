...
export const logLinkNavigation = async (komponent: string, destinasjon?: string) => {
  await analyticsLogger("navigere", { komponent: komponent, kategori: "tms-varsel", origin: APP_NAME});
};
