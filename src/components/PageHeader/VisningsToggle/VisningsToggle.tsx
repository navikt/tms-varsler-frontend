...
export const VisningsToggle = () => {
  ...
  return (
    <ToggleGroup
      ...
      size="medium"
      onChange={mapToSetViewFunction}
    >
      <ToggleGroup.Item value="nye" label={text.newToggle[DOCUMENT_LOCALE] + varselCountText} />
      <ToggleGroup.Item value="tidligere" label={text.previousToggle[DOCUMENT_LOCALE]} />
    </ToggleGroup>
  );
};
